...
***Answer***
It takes 10 seconds to ingest `labevents.parquet`, convert it to a DuckDB table, and filter the selected columns. The number of rows in the result tibble is 24855909, and I sort the duck _db file to get rid of uncertainty and it matches those in Q2.3.
...
labevents_duckdb <- dplyr::arrange(labevents_duckdb, subject_id)

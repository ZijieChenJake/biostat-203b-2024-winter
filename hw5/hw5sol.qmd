...
last_careunit,dod, outtime ,dischitime and also we have to remove los because 
it is a target variable. deathtime, edregtime and edouttime are also removed 
since they have too many missing values. I have also dropped admit_provider_id,
...
useless since we have already have the anchor_year. I would drop all rows 
with missing values. Since impute too many missing values will make
the model biased. 
